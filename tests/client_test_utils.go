...
var browserFingerprints = map[string]map[string]map[string]string{
	...
	firefox: {
		tls.HelloFirefox_102.Str(): map[string]string{
			ja3String:             "771,4865-4867-4866-49195-49199-52393-52392-49196-49200-49162-49161-49171-49172-156-157-47-53,0-23-65281-10-11-35-16-5-34-51-43-13-45-28-21,29-23-24-25-0-1,0",
			ja3Hash:               "02c2abd658e2eca2f848a948c87061d8",
