...
func TestClient_Firefox_104(t *testing.T) {
	options := []tls_client.HttpClientOption{
		tls_client.WithClientProfile(tls_client.Firefox_104),
	}
	...
	compareResponse(t, browserFingerprints[firefox][tls.HelloFirefox_104.Str()], resp)
}
